            ...
            case R.id.btnShare:
                if(receivedBitmap != null){
                    if(edtDescription.getText().toString().equals("")){
                        FancyToast.makeText(getContext(),"Error : You must Add the Description ",FancyToast.LENGTH_SHORT,FancyToast.ERROR,true).show();
                    }
                    else{
                    ...
                    FancyToast.makeText(getContext(),"Error : You must select the Image ",FancyToast.LENGTH_SHORT,FancyToast.ERROR,true).show();
        ...
        if(requestCode == 2000){
            if(resultCode ==Activity.RESULT_OK){
                try {
                    ...
                    imgShare.setImageBitmap(receivedBitmap);
